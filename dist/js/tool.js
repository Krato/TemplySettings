...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        getSettings: function getSettings() {
            ...
            Nova.request().get('/infinety-es/temply-settings/get-settings').then(function (response) {
                _this.settings = response.data.fields;
            });
        },
        saveSettings: function saveSettings() {
            ...
            Nova.request({
                ...
                _this2.$toasted.show(_this2.__('Settings saved! - Reloading page.'), { type: 'success' });
                ...
                if (error.response.status == 422) {
                    _this2.errorData = new __WEBPACK_IMPORTED_MODULE_0_laravel_nova__["Errors"](error.response.data.errors);
                }
            });
        },
        ...
        actionFormData: function actionFormData() {
            ...
            return _.tap(new FormData(), function (formData) {
                _.each(_this3.settings, function (setting) {
  ...
  return _c(
    ...
    [
      _c("heading", { staticClass: "mb-6" }, [
        _vm._v(_vm._s(_vm.__("Website Settings")))
      ]),
      _vm._v(" "),
          ...
          [
            _vm._l(_vm.settings, function(setting) {
              return [
                _c(
                  "div",
                  { class: { hidden: setting.hide } },
                  [
                    _c(setting.vue, {
                      tag: "component",
                      attrs: {
                        resourceName: _vm.resource,
            ...
            _c("div", { staticClass: "bg-30 flex px-8 py-4" }, [
              _c(
                ...
                {
                  staticClass:
                    "ml-auto btn btn-default btn-primary inline-flex items-center relative"
                },
                [
                  _c("span", { class: { invisible: _vm.working } }, [
                    _vm._v(
                      "\n                        " +
                        _vm._s(_vm.__("Save settings")) +
                        "\n                    "
                    )
                  ]),
                  _vm._v(" "),
